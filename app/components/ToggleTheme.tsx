...
export default function ToggleTheme() {
  ...
  return (
    <div
    className="relative z-0 inline-grid grid-cols-3 gap-0.5 rounded-full p-1 bg-gray-950/5  text-gray-950 dark:bg-white/10 dark:text-white"
    id="headlessui-radiogroup-«R65elb»"
    role="radiogroup"
  >
    <span
      className={` ${theme === 'system' && "bg-white ring inset-ring ring-gray-950/10 inset-ring-white/10 dark:bg-gray-700 dark:text-white"} rounded-full p-1.5 *:size-7  sm:p-0`}
    ...
    <span
      className={` ${theme === 'light' && "bg-white ring inset-ring ring-gray-950/10 inset-ring-white/10 dark:bg-gray-700 dark:text-white"} rounded-full p-1.5 *:size-7  sm:p-0`}
    ...
    <span
      className={` ${theme === 'dark' && "bg-white ring inset-ring ring-gray-950/10 inset-ring-white/10 dark:bg-gray-700 dark:text-white"} rounded-full p-1.5 *:size-7  sm:p-0`}
